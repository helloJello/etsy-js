(function() {
  ...
  Shop = (function() {
    ...
    Shop.prototype.findAllListings = function(params, cb) {
      return this.client.get("/shops/" + this.shopId + "/listings/active", params, function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
          return cb(new Error('Shop listings error'));
        } else {
          return cb(null, body, headers);
        }
      });
    ...
    Shop.prototype.activeListings = function(params, cb) {
      return this.client.get("/shops/" + this.shopId + "/listings/active", params, function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
          return cb(new Error('Active listings error'));
        } else {
          return cb(null, body, headers);
        }
      });
